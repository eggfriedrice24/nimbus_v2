      ...
      {items.map((item) =>
        item.items?.length ? (
          <Collapsible
            key={item.title}
            asChild
            defaultOpen={item.isActive ?? isActiveRoute(item.url)}
          >
            <li>
              <div className="relative flex items-center">
                <Link
                  href={item.url}
                  className={cn(
                    "flex h-8 min-w-8 flex-1 items-center gap-2 overflow-hidden rounded-md px-1.5 text-sm font-medium outline-none ring-ring transition-all hover:bg-secondary hover:text-secondary-foreground focus-visible:ring-2",
                    isActiveRoute(item.url, true) &&
                  ...
                  {item.items?.map((subItem) => (
                    <li key={subItem.title}>
                      <Link
                        href={subItem.url}
                        className={cn(
                          "flex h-8 min-w-8 items-center gap-2 overflow-hidden rounded-md px-2 text-sm font-medium text-muted-foreground ring-ring transition-all hover:bg-secondary hover:text-secondary-foreground focus-visible:ring-2",
          ...
          <li key={item.title}>
            <Link
              href={item.url}
              className={cn(
                "flex h-10 min-w-8 flex-1 items-center gap-2 overflow-hidden rounded-md px-1.5 text-sm font-medium outline-none ring-ring transition-all hover:bg-secondary hover:text-secondary-foreground focus-visible:ring-2",
