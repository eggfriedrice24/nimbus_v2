...
import { patchTasksSchema, type Task } from "@/server/db/schema/tasks"
...
import { useUpdateTask } from "../services/use-update-task"

type UpdateTaskSchemaType = z.infer<typeof patchTasksSchema>
...
export function UpdateTaskForm({
  ...
  const { mutate, isPending } = useUpdateTask({
    dialogOpen: setUpdateDialogOpen,
  })
  ...
  function onSubmit(input: UpdateTaskSchemaType) {
    mutate({
      json: input,
